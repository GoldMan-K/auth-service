...
public class KafkaConfig {
    ...
    // ── Consumer: member.created ───────────────────────────────────────────────

    @Bean
    public ConsumerFactory<String, MemberCreatedEvent> memberCreatedConsumerFactory() {
        JsonDeserializer<MemberCreatedEvent> deserializer =
                new JsonDeserializer<>(MemberCreatedEvent.class, false);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MemberCreatedEvent> memberCreatedListenerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, MemberCreatedEvent> factory =
    ...
    @Bean
    public ConsumerFactory<String, MemberSuspendedEvent> memberSuspendedConsumerFactory() {
        JsonDeserializer<MemberSuspendedEvent> deserializer =
